...
public class Type2Question{
    ...
    public String generateQuestion (String template){
        ...
        Type2ResultSet resultSet = getValidResultSet(tokens);
    ...
    private Type2ResultSet getValidResultSet(ArrayList<String> tokens) {
        ...
        if (validSubclassesOfX.isEmpty()) {
            ...
            for (OWLClass subclass  : validSubclassesOfX) {
                ...
                Type2ResultSet r = validateAxioms(axioms,subclass, OP, classY);
    ...
    private Type2ResultSet validateAxioms(ArrayList<OWLClassAxiom> axioms, OWLClass CurrentSubclass, OWLObjectPropertyExpression OP, OWLClass classY) {

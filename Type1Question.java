...
public class Type1Question {
    ...
    private Type1ResultSet getValidResultSet(ArrayList<String> tokens) {
        ...
        if (validSubclassesOfX.isEmpty()) {
            ...
            for (OWLClass subclass  : validSubclassesOfX) {
                ...
                Type1ResultSet r = validateAxioms(axioms,subclass, OP, classY);
    ...
    private Type1ResultSet validateAxioms(ArrayList<OWLClassAxiom> axioms, OWLClass CurrentSubclass, OWLObjectPropertyExpression OP, OWLClass classY) {

...
public class Type4Question {
    ...
    String generateQuestion(String template) {
        ...
        Type1ResultSet resultSet = getValidResultSet(tokens);
    ...
    private Type1ResultSet getValidResultSet(ArrayList<String> tokens) {
        ...
        if (!validSubclassesOfX.isEmpty()) {
            for (OWLClass superClass  : validSubclassesOfX) {
                for (Node<OWLClass> subClass: reasoner.getSubClasses(superClass, true)){
                    ...
                    if (!axioms.isEmpty()){
                        r = validateAxioms(axioms,superClass,subClass.getRepresentativeElement(), OP, classY);
                    }
    ...
    private Type1ResultSet validateAxioms(ArrayList<OWLClassAxiom> axioms,OWLClass currentSuperclass, OWLClass CurrentSubclass, OWLObjectPropertyExpression OP, OWLClass classY) {

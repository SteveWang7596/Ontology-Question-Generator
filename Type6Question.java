...
class Type6Question {
    ...
    private Type3ResultSet validateAxioms(ArrayList<OWLClassAxiom> axioms, OWLClass CurrentsuperClass, OWLClass CurrentSubclass, OWLObjectPropertyExpression OP, OWLClass classY) {
